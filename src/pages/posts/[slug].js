...
export default function PostPage({ source, frontMatter, posts }) {
  ...
  return (
    <Layout version={version} setMode={setMode}>
      <div className="flex">
        <Sidebar posts={posts} path={""} />

        <div className="min-w-0 w-full flex-auto lg:static lg:max-h-full lg:overflow-visible">
          <main className="sm:p-10 p-2 bg-gray-200 dark:bg-gray-800">
            <div className="bg-white dark:bg-gray-900 p-4 lg:p-10  shadow-md dark:text-white">
              <h1>
