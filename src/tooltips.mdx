...
Tooltips are those elements that are over the editor, in other words are non editable elements but are editor's tools. ie: the popover for text style or the plus icon to add embeds, images etc.
