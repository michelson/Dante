...
const EditorContainer = styled.div`
  ...
  font-family: ${(props: any) => props.theme.dante_font_family_serif} !important;
  ...
  .public-DraftEditorPlaceholder-root {
    color: ${(props: any) => lighten(0.1, props.theme.dante_text_color)};
    position: absolute;
    z-index: 0;
    font-size: ${(props: any) => math(`${props.theme.dante_editor_font_size}* 0.9`)};
  ...
  .graf--code {
    ...
    background: ${(props: any) => props.theme.dante_code_background};
    font-family: ${(props: any) => props.theme.dante_font_family_mono};
    font-size: ${(props: any) => props.theme.dante_editor_font_size};
    margin-bottom: 20px;
    padding: 20px;
    white-space: pre-wrap;
    color: ${(props: any) => props.theme.dante_code_color};

    .dante-code-syntax {
      color: ${(props: any) => props.theme.dante_code_background};
      position: absolute;
      top: 4px;
      right: 4px;
      width: 165px;
  ...
  .graf--p {
    code {
      ...
      color: ${(props: any) => props.theme.dante_control_color};
  ...
  h1.graf--h {
    font-family: ${(props: any) => props.theme.dante_font_family_sans};
    font-size: ${(props: any) =>
  ...
  h2.graf--h {
    font-family: ${(props: any) => props.theme.dante_font_family_sans};
    font-size: ${(props: any) => math(`${props.theme.dante_editor_font_size} * 2`)};
    font-style: normal;
    font-weight: 600;
    letter-spacing: -0.04em;
    line-height: 1;
  ...
  h4.graf--h {
    ...
    margin-left: -1.5px;
    line-height: 1.2;
    color: ${(props: any) => lighten(0.3, props.theme.dante_text_color)};
    margin-top: 40px;
    margin-bottom: 0.6em;
  }
  ...
  .graf--blockquote,
  blockquote {
    font-family: ${(props: any) => props.theme.dante_font_family_serif};
  ...
  .graf--mixtapeEmbed {
    ...
    border-color: ${(props: any) => props.theme.dante_control_color};
    border-radius: 5px;
    border-style: solid;
    border-width: 1px;
    box-sizing: border-box;
  ...
  .graf--divider span:before {
    ...
    margin-left: 0.6em;
    position: relative;
    color: ${({ theme } : {theme: any}) => theme.dante_text_color};
    top: -3px;
  }
  ...
  .imageCaption {
    ...
    font-size: 13px;
    line-height: 1.4;
    color: ${(props: any) => lighten(0.2, props.theme.dante_text_color)};
    outline: 0;
    z-index: 300;
    margin-top: 10px;
    //position: relative;
...
export const InlinetooltipWrapper = styled.div`
  ...
  position: absolute;
  z-index: 10;
  width: ${(props: any) => props.theme.tooltip_size};
  height: ${(props: any) => props.theme.tooltip_size};
  ...
  &.is-scaled {
    ...
    .control {
            -webkit-transition: -webkit-${(props: any) =>
              props.theme.tooltip_backward_transition}, ${(props: any) =>
  ...
  props.theme.tooltip_default_transition};
       -webkit-transform: rotate(45deg) !important;
           -ms-transform: rotate(45deg) !important;
            ...
            border-color: ${(props: any) => props.theme.tooltip_color};
                   color: ${(props: any) => props.theme.tooltip_color};
    }
  ...
  .inlineTooltip-menu {
    ...
    svg path{
      fill: ${(props: any) => props.theme.tooltip_color};
    }
  }
  ...
  .inlineTooltip-button {
    ...
    float: left;
    margin-right: ${(props: any) => props.theme.tooltip_button_spacing};
    display: inline-block;
    position: relative;
    outline: 0;
    padding: 0;
    ...
    box-sizing: border-box;
    border-radius: ${(props: any) => props.theme.tooltip_border_radius};
    cursor: pointer;
    font-size: 14px;
    text-decoration: none;
    font-family: ${(props: any) => props.theme.dante_font_family_sans};
    ...
    width: ${(props: any) => props.theme.tooltip_size};
    height: ${(props: any) => props.theme.tooltip_size};
    line-height: ${(props: any) => props.theme.tooltip_line_height};
    -webkit-transition: 100ms border-color, 100ms color;
    transition: 100ms border-color, 100ms color;
    background: ${(props: any) => props.theme.tooltip_background_color};
    border: ${(props: any) => props.theme.tooltip_border_width} solid;
    border-color: ${(props: any) => opacify(0.2, props.theme.tooltip_border_color)};
    color: ${(props: any) => props.theme.tooltip_color};

    &:hover {
      border-color: ${(props: any) => opacify(0.4, props.theme.tooltip_border_color)}
      color: rgba(${(props: any) => props.theme.tooltip_color}, ${(props: any) =>
    ...
    &.scale {
       ...
       -webkit-transform: scale(0);
           -ms-transform: scale(0);
               transform: scale(0);
      -webkit-transition: -webkit-${(props: any) =>
        props.theme.tooltip_forward_transition}, ${(props: any) =>
  props.theme.tooltip_default_transition};
              transition: ${(props: any) =>
                props.theme.tooltip_forward_transition}, ${(props: any) =>
  props.theme.tooltip_default_transition};
    ...
    &.control {
      ...
      display: block;
      position: absolute;
      margin-right: ${(props: any) => props.theme.tooltip_menu_spacing};
      padding-top: 4px;
