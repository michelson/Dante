(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@tiptap/react'), require('lowlight/lib/core'), require('@tiptap/core'), require('prosemirror-view'), require('prosemirror-state'), require('@tiptap/extension-text-style'), require('@emotion/styled'), require('polished'), require('@tiptap/starter-kit'), require('@tiptap/extension-code-block-lowlight'), require('@tiptap/extension-focus'), require('@emotion/react'), require('react-colorful'), require('axios'), require('medium-zoom'), require('prop-types'), require('use-countdown-timer')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@tiptap/react', 'lowlight/lib/core', '@tiptap/core', 'prosemirror-view', 'prosemirror-state', '@tiptap/extension-text-style', '@emotion/styled', 'polished', '@tiptap/starter-kit', '@tiptap/extension-code-block-lowlight', '@tiptap/extension-focus', '@emotion/react', 'react-colorful', 'axios', 'medium-zoom', 'prop-types', 'use-countdown-timer'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Dante = {}, global.React, global.react, global.core$1, global.core, global.prosemirrorView, global.prosemirrorState, global.TextStyle, global.styled, global.polished, global.StarterKit, global.CodeBlockLowlight, global.Focus, global.react$1, global.reactColorful, global.axios, global.mediumZoom, global.PropTypes, global.useCountdownTimer));
})(this, (function (exports, React, react, core$1, core, prosemirrorView, prosemirrorState, TextStyle, styled, polished, StarterKit, CodeBlockLowlight, Focus, react$1, reactColorful, axios, mediumZoom, PropTypes, useCountdownTimer) { 'use strict';
  ...
  var StyleWrapper$3 = styled(react.NodeViewWrapper)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject([""], [""])));
  ...
  */
  ...
  var StyleWrapper$1 = styled(react.NodeViewWrapper)(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject([""], [""])));
  ...
  var Tiptap = function (_a) {
      ...
      return (React.createElement(react$1.ThemeProvider, { theme: resolvedTheme },
          React.createElement(EditorContainer, null,
              React.createElement(React.Fragment, null,
                  ...
                  editor && !fixed &&
                      React.createElement(react.FloatingMenu, { editor: editor, tippyOptions: { duration: 100 } }, isPopOverEnabledFor() && (React.createElement("div", { style: { position: "absolute", top: -15, left: -60 } },
