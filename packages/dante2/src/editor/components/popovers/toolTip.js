...
class DanteTooltip extends React.Component {
  ...
  relocate =()=> {
    ...
    const relativeParent = getRelativeParent(this.dante_menu.current.parentElement);
    ...
    let crossedRightBorder = relativeRect.width - left - (this.dante_menu.current.clientWidth)
