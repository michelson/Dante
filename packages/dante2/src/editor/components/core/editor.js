...
export default class DanteEditor extends React.Component {
  ...
  handleUndeletables = (editorState) => {
    ...
    if (undeletable_types.length > 0 && undeletablesMap.size === 0) {
      ...
      return (editorState = EditorState.push(
        editorState,
        newContentState,
        "change-block"
      ));
  ...
  styleForBlock = (block, currentBlock, is_selected) => {
    ...
    const selected_class = dataBlock.selected_class
  ...
  handleBeforeInput = (chars) => {
    ...
    const blockTo = this.props.character_convert_mapping[
      ...
      <div suppressContentEditableWarning={true}>
        <div className="postContent">
          {this.props.tooltips
            ...
            .map((o, i) => {
              return this.renderTooltips(o, i);
            })}
