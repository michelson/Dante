...
import { isEmpty, capitalize, debounce } from 'lodash';
import { EditorState, genKey, ContentBlock, convertFromHTML, getSafeBodyFromHTML, ContentState, convertFromRaw, SelectionState, convertToRaw, Modifier, RichUtils, Entity, getDefaultKeyBinding, DefaultDraftBlockRenderMap, Editor, getVisibleSelectionRect, EditorBlock, CompositeDecorator } from 'draft-js';
...
var FileBlock = /*#__PURE__*/function (_React$Component) {
  ...
  function FileBlock(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      }, /*#__PURE__*/React.createElement(file, null), fileName), _this.state.loading && /*#__PURE__*/React.createElement(Loader$1, {
