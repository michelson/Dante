      ...
      return _react.default.createElement("div", {
        ...
        render: function render(_ref) {
          var start = _ref.start,
              ...
              pause = _ref.pause,
              resume = _ref.resume;
          return _react.default.createElement("div", null, !_this3.isReadOnly() ? _react.default.createElement(StatusBar, {
            contentEditable: false,
            loading: _this3.state.loading
          }, _this3.state.loading ? _react.default.createElement(Loader, {
            toggle: _this3.state.loading,
            progress: _this3.state.loading_progress
          }) : null) : null, _react.default.createElement(VideoBody, null, !_this3.isReadOnly() ? _react.default.createElement(EditorControls, {
            contentEditable: false
          ...
          }, !_this3.state.loading ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(RecButton, {
          ...
          }, _this3.state.recording ? "recording. (".concat(_this3.state.secondsLeft, " seconds left)") : "press button to start recording"), _react.default.createElement(SecondsLeft, null)) : null), _this3.state.fileReady && !_this3.state.loading ? _react.default.createElement(Button, {
            onClick: function onClick(e) {
              e.preventDefault();

              _this3.confirm();
            }
          }, "confirm recording upload ?") : null) : null, _react.default.createElement(VideoPlayer, {
            autoPlay: true,
            muted: true
          }), _react.default.createElement("figcaption", {
            className: "imageCaption",
            onMouseDown: _this3.handleFocus
          }, _this3.props.block.getText().length === 0 ? _react.default.createElement("span", {
            className: "danteDefaultPlaceholder"
          }, _this3.placeholderText()) : undefined, _react.default.createElement(_draftJs.EditorBlock, Object.assign({}, _this3.props, {
            "editable": true,
            "className": "imageCaption"
          })))));
        }
...
function (_React$Component2) {
  ...
  function Loader() {
    ...
    _defineProperty(_assertThisInitialized(_this4), "render", function () {
      return _react.default.createElement(_react.default.Fragment, null, _this4.props.toggle ? _react.default.createElement("div", {
        className: "image-upoader-loader",
        style: {
          width: '100%',
          textAlign: 'center'
        }
      }, _react.default.createElement("p", null, _this4.props.progress === 100 ? "processing video..." : _react.default.createElement("span", null, _react.default.createElement("span", null, "uploading video ", " "), Math.round(_this4.props.progress), "%"))) : null);
    });
