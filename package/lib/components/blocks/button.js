...
exports.ButtonBlockConfig = exports.default = void 0;
...
function (_React$Component) {
  ...
  function ButtonBlock(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateData", function () {
      (0, _commons.UpdateData)(_assertThisInitialized(_this));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "popoverTop", function () {
      return _react.default.createElement(ButtonControls, {
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      return _react.default.createElement("div", {
      ...
      }, _react.default.createElement(_reactPopper.Manager, null, _react.default.createElement(_reactPopper.Reference, null, function (_ref) {
        ...
        }, _defineProperty(_React$createElement, "href", _this.state.href), _defineProperty(_React$createElement, "onMouseOver", _this._showPopLinkOver), _defineProperty(_React$createElement, "onMouseOut", _this._hidePopLinkOver), _React$createElement), _react.default.createElement(_draftJs.EditorBlock, Object.assign({}, _this.props)));
      }), _this.state.displayPopOver ? _react.default.createElement(_reactPopper.Popper, {
        placement: "top"
      }, function (_ref2) {
        var ref = _ref2.ref,
            style = _ref2.style,
        ...
        }, "Popper element"), _react.default.createElement(ButtonControls, {
          changeLabel: _this.changeLabel,
          label: _this.state.label,
          changeHref: _this.changeHref,
          handleFloat: _this.handleFloat,
  ...
  _createClass(ButtonControls, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        id: "link"
      }, (0, _icons.link)()), _react.default.createElement("input", {
      ...
      })), this.state.fontColorPicker ? _react.default.createElement("div", {
        style: {
          position: "absolute"
        }
        ...
        trigger: function trigger(ctx) {
          return _react.default.createElement("button", {
            ...
            type: "button"
          }, _this3.props.buttonStyle.fontSize, _react.default.createElement("span", {
            className: "caret"
          }));
        },
        ...
        trigger: function trigger(ctx) {
          return _react.default.createElement("button", {
            ...
            className: "selected"
          }, _this3.props.buttonStyle.fontFamily), _react.default.createElement("span", {
            className: "caret"
          }));
        },
        target: function target(ctx) {
      ...
      })), this.state.buttonColorPicker ? _react.default.createElement("div", {
        style: {
          position: "absolute"
        }
      }, _react.default.createElement(_reactColor.SketchPicker, {
...
exports.ButtonBlockConfig = ButtonBlockConfig;