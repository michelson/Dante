...
exports.DanteImagePopoverConfig = exports.default = void 0;
  ...
  function DanteImagePopover(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "relocate", function () {
      ...
      if (editorState.getSelection().isCollapsed()) {
        ...
        if (blockType === "image") {
          ...
          var relativeParent = (0, _selection.getRelativeParent)(el.parentElement);
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      return _react.default.createElement(_menu.AnchorStyle, {
        ...
        return _react.default.createElement(DanteImagePopoverItem, {
          item: item,
...
function (_React$Component2) {
  ...
  function DanteImagePopoverItem() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "render", function () {
      ...
      }, _icons.default["image".concat((0, _lodash.capitalize)(_this2.props.item.type))]()));
    });
...
var _default = DanteImagePopover;
