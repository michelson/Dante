...
function () {
  ...
  _createClass(SaveBehavior, [{
    ...
    value: function checkforStore(content) {
      // ENTER DATA STORE
      var isChanged = !_immutable.default.is(_immutable.default.fromJS(this.editorContent), _immutable.default.fromJS(content)); // console.log("CONTENT CHANGED:", isChanged)
