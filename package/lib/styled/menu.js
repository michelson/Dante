...
var AnchorStyle = _styledComponents.default.div(_templateObject, function (props) {
  ...
  return (0, _polished.math)("".concat(props.theme.dante_menu_caret_size, " / 2"));
}, function (props) {
  return props.theme.dante_menu_background;
}, function (props) {
  return (0, _polished.math)("".concat(props.theme.dante_menu_caret_size, " * 2 - 1"));
}, function (props) {
  return props.theme.dante_menu_color;
}, function (props) {
  return props.theme.dante_menu_background;
}, function (props) {
  return (0, _polished.math)("".concat(props.theme.tooltip_caret_size, " / 2"));
}, function (props) {
  return (0, _polished.math)("".concat(props.theme.tooltip_caret_size, "/2"));
}, function (props) {
  ...
  return (0, _polished.math)("".concat(props.theme.dante_menu_height, " - 18"));
}, function (props) {
  return props.theme.dante_menu_height;
}, function (props) {
...
exports.AnchorStyle = AnchorStyle;