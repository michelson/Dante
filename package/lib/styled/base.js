...
var EditorContainer = _styled.default.div(_templateObject, function (props) {
  ...
  return (0, _polished.math)("".concat(props.theme.dante_editor_font_size, " - 6"));
}, function (props) {
  return props.theme.dante_editor_line_height;
}, function (props) {
  return (0, _polished.opacify)(0.8, props.theme.dante_text_color);
}, function (props) {
  return (0, _polished.math)("".concat(props.theme.dante_editor_font_size, "* 0.9"));
}, function (props) {
  ...
  return (0, _polished.lighten)(0.3, props.theme.dante_text_color);
}, function (props) {
  return props.theme.dante_font_family_serif;
}, function (props) {
  return props.theme.dante_font_family_serif;
...
var InlinetooltipWrapper = _styled.default.div(_templateObject2, function (props) {
  ...
  return (0, _polished.math)("".concat(props.theme.tooltip_size, " + ").concat(props.theme.tooltip_menu_spacing));
}, function (props) {
  return props.theme.tooltip_color;
}, function (props) {
  ...
  return (0, _polished.opacify)(0.2, props.theme.tooltip_border_color);
}, function (props) {
  return props.theme.tooltip_color;
}, function (props) {
  return (0, _polished.opacify)(0.4, props.theme.tooltip_border_color);
}, function (props) {
  return props.theme.tooltip_color;
}, function (props) {
...
exports.InlinetooltipWrapper = InlinetooltipWrapper;
