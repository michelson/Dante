(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('immutable'), require('draft-js'), require('react'), require('axios'), require('lodash'), require('draft-convert'), require('draft-js-custom-styles'), require('styled-components'), require('polished'), require('react-dom'), require('react-color'), require('react-select'), require('prismjs'), require('draft-js-prism'), require('draft-js-multidecorators')) :
  typeof define === 'function' && define.amd ? define(['immutable', 'draft-js', 'react', 'axios', 'lodash', 'draft-convert', 'draft-js-custom-styles', 'styled-components', 'polished', 'react-dom', 'react-color', 'react-select', 'prismjs', 'draft-js-prism', 'draft-js-multidecorators'], factory) :
  (global.Dante = factory(global.Immutable,global.draftJs,global.React,global.axios,global.lodash,global.draftConvert,global.createStyles,global.styled,global.polished,global.ReactDOM,global.reactColor,global.Select,global.Prism,global.PrismDecorator,global.MultiDecorator));
}(this, (function (Immutable,draftJs,React,axios,lodash,draftConvert,createStyles,styled,polished,ReactDOM,reactColor,Select,Prism,PrismDecorator,MultiDecorator) { 'use strict';
  ...
  */
  ...
  var AnchorStyle = styled__default.div(_templateObject, function (props) {
  ...
  var EditorContainer = styled__default.div(_templateObject$1, function (props) {
  ...
  var InlinetooltipWrapper = styled__default.div(_templateObject2, function (props) {
